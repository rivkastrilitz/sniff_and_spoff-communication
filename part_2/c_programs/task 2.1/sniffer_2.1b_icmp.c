        ...
        const u_char *packet)
{
  ...
  { printf("icmp packet information: \nthe type is %d\n the code is: %d\n",(int)(icmp_h->type),(int)(icmp_h->code));
...
int main()
{
  ...
  // filter, the sniffer will get only icmp between two hosts
  pcap_compile(handle, &fp, "proto icmp and host 10.0.2.15 and 8.8.8.8", 0, net);     
